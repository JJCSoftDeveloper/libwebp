...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/JJCSoftDeveloper/libwebp"
  s.license      = { :type => "BSD", :file => "COPYING" }
  s.author       = { "蒋京春" => "jiangjingchun@longfor.com" }
  s.source       = { :git => "https://github.com/JJCSoftDeveloper/libwebp.git", :tag => 'v0.6.1' }
